...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(GunmanUser = new(conn));
            AddTable(Bullet = new(conn));
            AddTable(CharacterLevelData = new(conn));
            AddTable(DbChest = new(conn));
            AddTable(Diamond = new(conn));
            AddTable(GameConfigs = new(conn));
            AddTable(OnlinePlayerInUser = new(conn));
            AddTable(OnlinePlayerOutUser = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.GunmanUser().ToSql(),
            new QueryBuilder().From.Bullet().ToSql(),
            new QueryBuilder().From.CharacterLevelData().ToSql(),
            new QueryBuilder().From.DbChest().ToSql(),
            new QueryBuilder().From.Diamond().ToSql(),
            new QueryBuilder().From.GameConfigs().ToSql(),
            new QueryBuilder().From.OnlinePlayerInUser().ToSql(),
            new QueryBuilder().From.OnlinePlayerOutUser().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<GunmanUser, GunmanUserCols, GunmanUserIxCols> GunmanUser() => new("GunmanUser", new GunmanUserCols("GunmanUser"), new GunmanUserIxCols("GunmanUser"));
        ...
        public global::SpacetimeDB.Table<CharacterLevelDataConfig, CharacterLevelDataCols, CharacterLevelDataIxCols> CharacterLevelData() => new("character_level_data", new CharacterLevelDataCols("character_level_data"), new CharacterLevelDataIxCols("character_level_data"));
        public global::SpacetimeDB.Table<DbChest, DbChestCols, DbChestIxCols> DbChest() => new("db_chest", new DbChestCols("db_chest"), new DbChestIxCols("db_chest"));
        public global::SpacetimeDB.Table<Diamond, DiamondCols, DiamondIxCols> Diamond() => new("diamond", new DiamondCols("diamond"), new DiamondIxCols("diamond"));
        public global::SpacetimeDB.Table<GameConfigs, GameConfigsCols, GameConfigsIxCols> GameConfigs() => new("game_configs", new GameConfigsCols("game_configs"), new GameConfigsIxCols("game_configs"));
        public global::SpacetimeDB.Table<Player, OnlinePlayerInUserCols, OnlinePlayerInUserIxCols> OnlinePlayerInUser() => new("online_player_in_user", new OnlinePlayerInUserCols("online_player_in_user"), new OnlinePlayerInUserIxCols("online_player_in_user"));
        public global::SpacetimeDB.Table<Player, OnlinePlayerOutUserCols, OnlinePlayerOutUserIxCols> OnlinePlayerOutUser() => new("online_player_out_user", new OnlinePlayerOutUserCols("online_player_out_user"), new OnlinePlayerOutUserIxCols("online_player_out_user"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.DespawnBullet args => Reducers.InvokeDespawnBullet(eventContext, args),
                Reducer.DespawnChest args => Reducers.InvokeDespawnChest(eventContext, args),
                Reducer.DespawnDiamond args => Reducers.InvokeDespawnDiamond(eventContext, args),
                Reducer.ExitGame args => Reducers.InvokeExitGame(eventContext, args),
                Reducer.Shooting args => Reducers.InvokeShooting(eventContext, args),
                Reducer.StartGame args => Reducers.InvokeStartGame(eventContext, args),
                Reducer.UpdateDirection args => Reducers.InvokeUpdateDirection(eventContext, args),
